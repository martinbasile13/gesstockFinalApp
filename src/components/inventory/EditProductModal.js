...
const EditProductModal = ({ open, handleClose, onProductUpdated, categories = [], branches = [], userId, product }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!userId || !product?.id) {
      setError('Error: Datos inválidos para la actualización');
      return;
    }
  ...
  return (
    ...
    >
      <Box sx={style}>
        <Typography id="modal-edit-product" variant="h6" component="h2" gutterBottom>
          Editar Producto
        </Typography>
